# RockyRAM - Checklist de reconexion

## 1. GitHub
- Crear un repositorio nuevo en la cuenta destino.
- Esta copia no tiene carpeta `.git`, asi que primero debes inicializar el repositorio local.
- En local, apuntar `origin` al repo nuevo:

```powershell
git init
git branch -M main
git remote add origin https://github.com/TU-USUARIO-O-ORG/RockyRAM.git
...
- No reutilizar claves del proyecto anterior.
