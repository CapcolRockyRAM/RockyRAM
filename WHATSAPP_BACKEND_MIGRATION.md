...
- Las credenciales heredadas fueron retiradas del archivo tracked `whatsapp-backend/.env`.
...
Tambien actualiza localmente `whatsapp-backend/.env` con esos mismos valores, usando `whatsapp-backend/.env.example` como base.
